	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="nav-item"><a class="nav-link" href="../logoutkusum.php">Logout</a></li>
			</ul>
		</div>
	</nav>
...
<?php
	...
	if(isset($_POST['issue_book'])){
		...
		$query = "insert into issued_books (`book_no`, `book_name`, `book_author`, `student_name`, `status`, `issue_date`) values('$_POST[book_no]','$_POST[book_name]','$_POST[book_author]','$_POST[student_name]',1,'$_POST[issue_date]')";
