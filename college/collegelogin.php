...
<div class="signup">
	<div class=input-group>
		<input type="text" name="" placeholder="First Name" class="inp">
		<input type="text" name="" placeholder="Last Name" class="inp">
		<input type="email" name="" placeholder="Email id" class="inp">
		<input type="password" name="" placeholder="Enter Password" class="inp">
		<input type="cpassword" name="" placeholder="Confirm Password" class="inp">
</div>
...
<div class="p">
	...
	<div class="center-box">
			...
			<div class="content-1">
				...
				<li style="text-decoration: none;"><a href="">Departments</a></li>
