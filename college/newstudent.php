...
<div class="main-attendance">
	...
	<div class="add-student-m">
		<h2>Add New Student</h2>
	</div>

<div class="input-attendance-m">
	<input type="text" name="" placeholder="Name"><br><br>
	<input type="text" name="" placeholder="Roll No."><br><br>
	<input type="email" name="" placeholder="Course"><br><br>
	<input type="text" name="" placeholder="Semester"><br><br>
		<input type="text" name="" placeholder="Branch"><br><br>
...
<div class="attendance-butt-m">
<a href="marking.php"><button>Back </button></a>
</div>
