...
<div class="content">
     <ul class="main-ul">
		...
		<ul>
		   <li>1 SEMESTER
			<ul>
			  <li>Maths notes download here
				<ul><input type="file" name="file"> 
				    <input type="submit" name="submit">
				</ul>
									
										</li>
									<li>Physics notes download here
										<ul><input type="file" name="file"> 
										<input type="submit" name="submit">
									</ul>

									</li>
									<li>workshop notes download here
										<ul><input type="file" name="file"> 
										<input type="submit" name="submit">
									</ul>

									</li>
									<li>maths books download here
										<ul><input type="file" name="file"> 
										<input type="submit" name="submit">
									</ul>
									</li>
							...
							<li>2 SEMESTER
							<ul>
									<li>inner shits here<ul><input type="file" name="file"> 
										<input type="submit" name="submit">
									</ul></li>
