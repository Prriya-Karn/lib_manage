...
<div class="main-attendance-a">

	<div class="h-attendace-m">
		<h1>Marking System</h1>
	</div>
	<br><br><br><br><br><br><br><br><br>
	<div class="add-student-a">
		<h2>Add New Record</h2>
	</div>

<div class="input-attendance-a">
	<input type="text" name="" placeholder="Name"><br><br>
	<input type="text" name="" placeholder="Course"><br><br>
	<input type="email" name="" placeholder="Branch"><br><br>
	<input type="text" name="" placeholder="Subject Name"><br><br>
		<input type="text" name="" placeholder="Subject Code"><br><br>
		<input type="text" name="" placeholder="Theory out of 80"><br><br>
		<input type="text" name="" placeholder="Pratical out of 20"><br><br>
...
<div class="attendance-butt-a">
<a href="addrecord.php"><button>Back </button></a>
</div>
