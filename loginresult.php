...
<body>
    <div>
        <img style="width: 150px; height: 90px; position: absolute; left: 10%; top:20px;  background-color: darkblue;  box-shadow: 2px 2px 4px #000000;" src="collegelogo.jpg">
    </div>
...
<br><br>
    ...
    <div class="main">
        ...
        <div class="search">
            <form action="./studentresult.php" method="get">
                <fieldset>
