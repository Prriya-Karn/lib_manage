...
<body>
    ...
    <div class="title">
        ...
        <a href="dashboard.php"><img src="collegelogo1.png" style="width: 150px; height: 90px; position: absolute; left: 10%; top:20px;  background-color: skyblue;  box-shadow: 2px 2px 4px #000000;"></a>
    
        <span class="heading">AIT RESULT</span>
        <a href="logoutresult.php" style="color: white"><span class="fa fa-sign-out fa-2x">Logout</span></a>
    </div>
