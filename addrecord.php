...
<div class="main-attendance">
	...
	<div class="a-student-m">
		<!-- <a href="addrecord.php">Add Record</a> -->
	</div>
	<br><br>

	<div class="table-attendance-r">
 ...
 <td>Priya Karn</td>
    <td>ITES&M</td>
    <th><a href="" style="color: black;"><i  class="fa fa-edit" ></i></a></th>
...
<div class="attendance-button-r">
<a href="add.php"><button>Add Record </button></a>
</div>
